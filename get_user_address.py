...
# Created on: Jan 2019
# This program gets users address and prints out their formal address


def get_address(name, street_address, city, province,
...
def main():
    ...
    if apt_number is not None:
        address = get_address(user_name, city, province, street_address,
